...
subtitle: Select the location closest to you to see where in the night sky the Geminid radiant will be on the night of 14 December into the morning of 15 December.
# for social previews
pagetitle: Where to look for the Geminids
description: Select the location closest to you to see where in the night sky the Geminid radiant will be on the night of 14 December into the morning of 15 December.
twitter-card:
  site: "@360info_global"
...
video = html`<div style="padding:56.25% 0 0 0;position:relative;">
  <iframe
    ...
    title="${selectedRegionRow.region}"></iframe>
</div>`
```
